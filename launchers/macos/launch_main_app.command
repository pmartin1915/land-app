...
# Alabama Auction Watcher - Main Application Launcher (macOS)
# Comprehensive macOS launcher for the Streamlit dashboard
...
if curl -s http://localhost:8001/health >/dev/null 2>&1; then
    ...
    echo "[INFO] Use launch_backend_api.command to start the backend"
    echo
fi
